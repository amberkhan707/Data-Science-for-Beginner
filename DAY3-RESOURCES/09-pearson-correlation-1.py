...
# kendall and spearmann are other two types
# kendalls tau is a value between 0 to 1. 0= no relationship, 1= perfect relationship
# Kendall’s Tau = (C – D / C + D)
# Where C is the number of concordant pairs and D is the number of discordant pairs. 
print("\Kendall Correlation output")
# correlations on height-weight
correlations1 = df1.corr(method='kendall')
print("Correlation Matrix between age and height and weight")
print(correlations1)
print()
